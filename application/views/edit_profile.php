        ...
        <ul class="nav nav-pills nav-stacked nav-email shadow mb-20">
            <li>
                <a href="#mail-inbox.html">
                    <i class="fa fa-inbox"></i> Profile  <span class="label pull-right">7</span>
                </a>
            </li>
            <li>
                <a href="#mail-inbox.html">
            ...
            <li>
                <a href="#mail-compose.html"><i class="fa fa-envelope-o"></i> Status Pembelian</a>
            </li>
            <li class="active">
                <a href="#mail-inbox.html">
                    <i class="fa fa-users"></i> Setting  <span class="label pull-right">7</span>
                </a>
            </li>
            <!-- <li>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="col-xs-12 col-sm-4">
                           <figure>
                              <img class="img-circle img-responsive" alt="" src="<?php echo base_url(); ?>/assets/images/profil.jpg">
                           </figure>
                        </div>
                        <div class="col-sm-8">
                          <form>
                           <ul class="list-group">
                              ...
                              <li class="list-group-item"><input type="text" name="first_name"></li>
                              <li class="list-group-item"><input type="text" name="last_name"></li>
                              <li class="list-group-item"><input type="text" name="jabatan"></li>
                              <li class="list-group-item"><input type="text" name="email"></li>
                              <li class="list-group-item"><input type="text" name="phone"></li>
                              <li class="list-group-item"><input type="text" name="alamat"></li>
                              <li class="list-group-item"><input type="text" name="new_password"></li>
                              <li class="list-group-item"><input type="text" name="new_password_again"></li>
                           </ul>
                           </form>
                        </div>
                     </div>
