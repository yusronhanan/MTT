...
<div class="products">	 
		<div class="container">
			<!-- <div class="jumbotron"> -->
        <img src="https://s0.bukalapak.com/uploads/campaign/28411/960x150.jpg" class="img-responsive" style="margin-left: auto;margin-right: auto;text-align: center;display: table-cell;vertical-align: middle">
        <p class="header-hotlist" style="color:black;text-align: center;vertical-align: middle;">"Kurma merupakan bla bla bla bla bla blabla blabla blabla blabla blabla blabla blabla blabla blabla bla"</p>
         <!-- </div> -->
				<!-- breadcrumbs --> 
				...
				<div class="products-row">
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="<?php echo base_url(); ?>page/detail_product/<?php echo $product->id ?>"><img title="<?php echo $product->name ?>" src="<?php echo base_url(); ?>/assets/images/e2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5 title="<?php echo $product->name ?>"><a href="<?php echo base_url(); ?>page/detail_product/<?php echo $product->id ?>/<?php echo $product->category_id ?>"><?php echo substr($product->name,0,14)."..<br>"; ?></a></h5> 
						...
						<button style="margin-top:5px" class="btn btn-primary" id="tambahwishlist"><i class="fa fa-heart" aria-hidden="true"></i></button>
				</div>
						</div>
					</div>
					 <?php endforeach;
