		...
		<div class="container"> 
			...
			<div class="sitemap-row"> 
				<nav class="sitemap-tabs" data-spy="affix" data-offset-top="400"> 
					<div  id="myNavbar">
						<ul> 
							<li><a href="#w3sec1"><i class="fa fa-coffee"></i> TSO Cafe</a></li>
							<li><a href="#w3sec2"><i class="fa fa-slideshare"></i>Fashion</a></li>
							<li><a href="#w3sec3"><i class="fa fa-cutlery"></i> Snack</a></li>
							<li><a href="#w3sec4"><i class="fa fa-home"></i> Properti</a></li>
							<li><a href="#w3sec5"><i class="fa fa-futbol-o"></i> Hobi</a></li> 
							<li><a href="#w3sec6"><i class="fa fa-shopping-basket"></i> Perlengkapan</a></li> 
							<li><a href="#w3sec7"><i class="fa fa-plane"></i> Travel dan Umroh</a></li> 
							<li><a href="#w3sec8"><i class="fa fa-medkit"></i> Kesehatan</a></li> 
							<li><a href="#w3sec9"><i class="fa fa-car"></i> Otomotif</a></li> 
							<li><a href="#w3sec10"><i class="fa fa-book"></i> Buku</a></li>
							<li><a href="#w3sec11"><i class="fa fa-pie-chart"></i> Usaha dan Jasa</a></li> 
							<li><a href="#w3sec12"><i class="fa fa-hand-scissors-o"></i> Kerajinan</a></li>  
						</ul> 
					</div>
				</nav>	
				<div id="w3sec1" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-coffee"></i> TSO Cafe</h3>  
				...
				<div id="w3sec2" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-slideshare"></i> Fashion</h3>  
					<div class="col-md-3 sitemap-text-grids">  
				...
				<div id="w3sec3" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-cutlery"></i> Snack</h3>
					<div class="col-md-3 sitemap-text-grids"> 
				...
				<div id="w3sec4" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-home"></i> Properti</h3> 
					<div class="col-md-3 sitemap-text-grids">
				...
				<div id="w3sec5" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-futbol-o"></i> Hobi</h3>
					<div class="col-md-3 sitemap-text-grids">
				...
				<div id="w3sec6" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-shopping-basket"></i> Perlengkapan</h3>
					<div class="col-md-3 sitemap-text-grids">
				...
				<div id="w3sec7" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-plane"></i> Travel dan Umroh</h3>
					<div class="col-md-3 sitemap-text-grids">
				...
				<div id="w3sec8" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-medkit"></i> Kesehatan</h3>  
					<div class="col-md-3 sitemap-text-grids">
				...
				<div id="w3sec9" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-car"></i> Otomotif</h3>   
					<div class="col-md-3 sitemap-text-grids">
				...
				<div id="w3sec10" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-book"></i> Buku</h3>  
					<div class="col-md-3 sitemap-text-grids">
				...
				<div id="w3sec11" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-pie-chart"></i> Usaha dan Jasa</h3>  
					<div class="col-md-3 sitemap-text-grids">
						<h5 class="sitemap-text-title"><a href="products9.html">Books</a></h5> 
						<ul>    
							<li><a href="products9.html">Academic Text </a></li>
				...
				<div id="w3sec12" class="container-fluid sitemap-text">
					<h3 class="w3sitemap-title"><i class="fa fa-hand-scissors-o"></i> Kerajinan</h3>  
					<div class="col-md-3 sitemap-text-grids">
						<h5 class="sitemap-text-title"><a href="products9.html">Books</a></h5> 
						<ul>    
							<li><a href="products9.html">Academic Text </a></li>
